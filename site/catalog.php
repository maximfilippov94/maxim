...
.catChip:hover,.catChip.active{background:rgba(191,127,43,.15);border-color:var(--copper);color:var(--copper2)}
...
.catalogSearch:focus{border-color:rgba(191,127,43,.5)}
...
<?php if(!$catSlug || $catSlug==='all'): ?>
  ...
  <div class="catGrid">
    ...
    <a class="catCard" href="/catalog.php?cat=<?=h($cat['slug'])?>">
      ...
      <?php else: ?>
        <div class="catCardPlaceholder"><svg viewBox="0 0 24 24" fill="none" width="52" height="52"><rect x="3" y="15" width="18" height="4" rx="1" fill="#bf7f2b"/><rect x="4" y="10" width="16" height="4" rx="1" fill="#d69a48"/><rect x="3" y="5" width="18" height="4" rx="1" fill="#4a4237"/></svg></div>
      <?php endif; ?>
...
<?php elseif($currentCat && !empty($currentSubs)): ?>
  ...
  <div class="catGrid" style="margin-bottom:32px">
    ...
    <a class="catCard" href="/catalog.php?cat=<?=h($sub['slug'])?>">
      ...
      <?php else: ?>
        <div class="catCardPlaceholder"><svg viewBox="0 0 24 24" fill="none" width="44" height="44"><rect x="3" y="15" width="18" height="4" rx="1" fill="#bf7f2b"/><rect x="4" y="10" width="16" height="4" rx="1" fill="#d69a48"/><rect x="3" y="5" width="18" height="4" rx="1" fill="#4a4237"/></svg></div>
      <?php endif; ?>
      <div class="catCardOverlay"></div>
      <div class="catCardBody">
