  ...
  <div class="catGrid">
    ...
    <a href="/catalog.php?cat=<?=h($cat['slug'])?>" class="catCard">
      ...
      <div class="catCardPlaceholder">
        <svg viewBox="0 0 24 24" fill="none" width="52" height="52"><rect x="3" y="15" width="18" height="4" rx="1" fill="#bf7f2b"/><rect x="4" y="10" width="16" height="4" rx="1" fill="#d69a48"/><rect x="3" y="5" width="18" height="4" rx="1" fill="#4a4237"/></svg>
      </div>
      <?php endif; ?>
