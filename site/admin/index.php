...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebarNav">
    <a data-tab="orders" class="<?=$tab==='orders'?'active':''?>">
      ...
      Заявки <?php if($stats['new']>0): ?><span style="background:var(--accent);color:#fff;border-radius:999px;padding:1px 7px;font-size:10px;font-weight:900;margin-left:auto"><?=$stats['new']?></span><?php endif; ?>
    </a>
