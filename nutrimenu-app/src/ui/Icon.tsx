...
export const PATHS: Record<string, string> = {
  ...
  /* Основание прежнего колокольчика торчало за края юбки острыми
     выступами — на мелком размере это читалось как кривизна.
     Здесь юбка сходится к основанию скруглением. */
  ...
  /* Мишень: цели и нормы. Два кольца и точка — тот же знак, что
     стоит у этого раздела в браузере. */
  ...
  /* Щит с галочкой — отметка о проверке. Тот же знак стоит в каталоге
     на сайте, чтобы клиент узнавал его в обоих местах. */
