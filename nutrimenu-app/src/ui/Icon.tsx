...
export const PATHS: Record<string, string> = {
  ...
  /* Гантель и «об упражнении» — для раздела тренировок. Сетка та же,
     обводка та же: иначе значок выбивается из ряда. */
  dumbbell: 'M4.2 9.2v5.6M7 7.6v8.8M17 7.6v8.8M19.8 9.2v5.6M7 12h10',
  info: 'M12 20.4a8.4 8.4 0 1 0 0-16.8 8.4 8.4 0 0 0 0 16.8ZM12 11v5.4M12 7.8h.01',
  ...
  /* Те же два, что в вебе: экран баланса показывает одни и те же
     движения на обеих платформах, и значки у них должны совпадать. */
